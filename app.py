    ...
    if input_method != 'none':
        if input_method == 'I want to provide only symptoms':
            ...
            if submit:
                ...
                # st.subheader(f'Based on your symptoms, you are {symptoms_outcome[0]} for COVID-19')
                st.markdown(f"<h3 style='text-align: left; color: blue;'>Based on your symptoms, you are {symptoms_outcome[0]} for COVID-19</h3>", unsafe_allow_html=True)
